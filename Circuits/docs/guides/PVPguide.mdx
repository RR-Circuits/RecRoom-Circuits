...
Configure the [int Variable](../../docs/documentation/Chips/33224907-68ff-4102-802e-7c3eed481d37) and rename it to `Health`, hit submit and set the value to whatever you want (this should be the max health). You can change the name to something else, but to make it clear that it's a health variable, we will be using `Health`.
